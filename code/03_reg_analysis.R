...
#'## Read in data
################################
dsdrop<- read.csv('intermediate_files/regression_vars.csv')
...
dsdrop <- dsdrop %>% filter(imagedate > '2018-01-01' , imagedate < '2020-01-01')

dsdrop2<-dsdrop2 %>%  dplyr::select(SIGLA_UF,pasture_201819_tot,stocking_rate, 
                                    defo_perc_wo_refo_13_17,defo_buffer_perc_13_17	,mod_deg_sum_201819,sev_deg_sum_201819,
                                    crop_201819_tot,agricultural_credits,mean_mun_msg4_1317,
                                    area,buffer_forest_tot_2013, precipitation_2018_19,mean_temp_18_19,
                                    population,nearest_fedSh, zdc_bin)
...
if(standardize){
dsdrop<- standardize_dataset(dsdrop, c(control_variables,dependent_variable,"defo_perc_wo_refo_13_17" ,"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot",
                 "agricultural_credits",  "zdc_exposure", 'mean_mun_msg4_1317','defo_buffer_abs_13_17'))

dsdrop2<- standardize_dataset(dsdrop2, c(control_variables,dependent_variable,"defo_perc_wo_refo_13_17" ,"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot",
                "agricultural_credits",  "zdc_exposure", 'mean_mun_msg4_1317','defo_buffer_abs_13_17'))

}
length(unique(dsdrop2$IBGE_CODE[dsdrop2$zdc_bin=='1']))
...
model1_formula <- as.formula(paste(dependent_variable, "~", paste(c(control_variables,
                "defo_perc_wo_refo_13_17" ,"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot"),
                            collapse = "+")))

#model 2 shows agricultural credits
model2_formula <- as.formula(paste(dependent_variable, "~", paste(c(control_variables,
              'defo_buffer_perc_13_17',"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot"),
                                                                  collapse = "+")))

model3_formula <- as.formula(paste(dependent_variable, "~", paste(c(control_variables,
               'defo_buffer_perc_13_17', 'defo_perc_wo_refo_13_17',"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot", "agricultural_credits"),collapse = "+")))



model4_formula <- as.formula(paste(dependent_variable, "~", paste(c(control_variables,
               'defo_buffer_perc_13_17', "defo_perc_wo_refo_13_17" ,"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot",  "mean_mun_msg4_1317"),
                                                                 collapse = "+")))
model5_formula <- as.formula(paste(dependent_variable, "~", paste(c(control_variables,
               'defo_buffer_perc_13_17', "defo_perc_wo_refo_13_17" ,"mod_deg_sum_201819","sev_deg_sum_201819","crop_201819_tot",  "agricultural_credits*zdc_bin"),collapse = "+")))
